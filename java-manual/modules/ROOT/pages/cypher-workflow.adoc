...
For more information, see link:{neo4j-docs-base-uri}/api/java-driver/{java-driver-version}/org/neo4j/driver/Value.html[Java Driver API documentation -> Interface Value].
